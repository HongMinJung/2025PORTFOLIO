...
export default function HeroMobile({ className }: { className?: string }) {
  ...
  return (
    <section ref={ref} className={"flex flex-col items-center justify-between snap-start h-full w-full pt-2 pb-20"  + (className || "") }>
      <div className="flex flex-col items-center justify-between min-h-[calc(100vh-112px)]">
        {/* top 텍스트 */}
        <motion.div 
        ...
        >
          ...
          <div>
            <Button
              className="flex items-center gap-2 border border-black dark:border-white px-6 py-3 rounded-lg bg-transparent hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-primary-500"
